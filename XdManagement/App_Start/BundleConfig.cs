namespace EficienciaEnergetica
{
    ...
    using EficienciaEnergetica.Constants;
    ...
    public static class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/bootstrap_v3.3.7/bootstrap.min.css",
                      "~/Content/animate.css",
                      "~/Content/style.css"));
            ...
            // jQuery
            //bundles.Add(new ScriptBundle("~/bundles/jquery").Include("~/Scripts/jquery-2.2.3.min.js"));
            //bundles.Add(new ScriptBundle("~/bundles/jquery").Include("~/Scripts/jquery-2.2.4.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include("~/Scripts/bootstrap_v3.3.7/bootstrap.min.js"));

            //Bootstrap Dialog CSS
            bundles.Add(new StyleBundle("~/bundles/bootstrapdialog/css").Include(
                "~/Content/plugins/bootstrap-dialog/bootstrap-dialog.css"));

            //Bootstrap Dialog Script
            bundles.Add(new ScriptBundle("~/bundles/bootstrapdialog").Include(
            ...
            // Bootstrap Select Combo CSS
            bundles.Add(new StyleBundle("~/bundles/bootstrapselect/css/").Include(
                      "~/Content/plugins/bootstrapSelector/bootstrap-select.min.css"));

            //Bootstrap Select Combo
            bundles.Add(new ScriptBundle("~/bundles/bootstrapselect").Include(
                      "~/Scripts/plugins/bootstrapSelector/bootstrap-select.min.js"));

            // Loading CSS
            bundles.Add(new ScriptBundle("~/Content/Loading").Include("~/Content/loading.css"));
